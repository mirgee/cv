...
% \hfill
\cvsect{Interests}{
\textbf{Professional:} distributed systems, cryptography, open-source, software architecture, machine learning and data science

\textbf{Personal:} self-improvement, (neuro)science, reading, playing music, running}
% \hspace{0.3\textwidth}
% %----------------------------------------------------------------------------------------
